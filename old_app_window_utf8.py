...
class AppWindow:
    ...
    def __init__(
        ...
        self._status = tk.StringVar(value="เธเธณเธฅเธฑเธเน€เธ•เธฃเธตเธขเธกเธเนเธญเธกเธนเธฅโ€ฆ")
        self._account = tk.StringVar(value="")
        self._entitlement = tk.StringVar(value="เธขเธฑเธเนเธกเนเธกเธตเธงเธฑเธเนเธเนเธเธฒเธ")
        ...
        self._game_connection_status = tk.StringVar(value="เธฃเธญเนเธซเนเน€เธเนเธฒเน€เธเธก (pso2.exe)")
        self._proxy_connection_status = tk.StringVar(value="ProxyCore เธขเธฑเธเนเธกเนเธ—เธณเธเธฒเธ")
    ...
    def _build_auth_view(self) -> None:
        ...
        self._auth_hint = ctk.CTkLabel(
            top_row,
            text="เน€เธเนเธฒเธชเธนเนเธฃเธฐเธเธเน€เธเธทเนเธญเน€เธฃเธดเนเธกเนเธเนเธเธฒเธ",
            text_color=PALETTE.primary_dark,
        ...
        ctk.CTkLabel(
            title_frame,
            text="เน€เธเนเธฒเธชเธนเนเธฃเธฐเธเธเนเธฅเธฐเธชเธกเธฑเธเธฃเธชเธกเธฒเธเธดเธ",
            font=ctk.CTkFont(family=FONT_FAMILY, size=18, weight="bold"),
            text_color=PALETTE.text,
        ).pack(anchor="center")
        ctk.CTkLabel(
        ...
        self._login_tab_btn = ctk.CTkButton(
            self._tab_controls,
            text="เน€เธเนเธฒเธชเธนเนเธฃเธฐเธเธ",
            fg_color=PALETTE.card,
        ...
        self._register_tab_btn = ctk.CTkButton(
            self._tab_controls,
            text="เธชเธกเธฑเธเธฃเธชเธกเธฒเธเธดเธ",
            fg_color="transparent",
            text_color="#888888",
            hover_color="#E5E7EB",
            corner_radius=18,
        ...
        self._field_label(login, "เธเธทเนเธญเธเธนเนเนเธเน")
        self._login_email_entry = self._icon_entry(
            login, "๐‘ค", "เธเธฃเธญเธเธเธทเนเธญเธเธนเนเนเธเน", self._login_email
        )
        self._field_label(login, "เธฃเธซเธฑเธชเธเนเธฒเธ")
        self._login_password_entry = self._icon_entry(
            login, "๐”’", "เธเธฃเธญเธเธฃเธซเธฑเธชเธเนเธฒเธ", self._login_password, show="โ—", right_icon="๐‘"
        )
        ...
        self._remember_me = ctk.CTkCheckBox(
            options_row,
            text="เธเธณเธเธฑเธเนเธงเนเนเธเธฃเธฐเธเธ",
            text_color=PALETTE.text_muted,
        ...
        forgot_pw = ctk.CTkLabel(
            options_row,
            text="เธฅเธทเธกเธฃเธซเธฑเธชเธเนเธฒเธ?",
            text_color=PALETTE.primary_dark,
            font=ctk.CTkFont(family=FONT_FAMILY, size=12, weight="bold"),
            cursor="hand2"
        )
        forgot_pw.pack(side="right", pady=(2, 0))
        forgot_pw.bind("<Button-1>", lambda e: self._notice.set("เธเธฃเธธเธ“เธฒเธ•เธดเธ”เธ•เนเธญเนเธญเธ”เธกเธดเธเน€เธเธทเนเธญเธฃเธตเน€เธเนเธ•เธฃเธซเธฑเธชเธเนเธฒเธ"))
        
        self._login_button = self._primary_button(
            login, "เน€เธเนเธฒเธชเธนเนเธฃเธฐเธเธ โ”", self._login
        )
        self._login_button.pack(side="bottom", fill="x", padx=14, pady=(10, 14))

        # Register Frame
        register = self._register_frame
        self._field_label(register, "เธเธทเนเธญเธเธนเนเนเธเน")
        self._register_email_entry = self._icon_entry(
            register, "๐‘ค", "เธเธฃเธญเธเธเธทเนเธญเธเธนเนเนเธเน", self._register_username
        )
        self._field_label(register, "เธฃเธซเธฑเธชเธเนเธฒเธ (เธญเธขเนเธฒเธเธเนเธญเธข 8 เธ•เธฑเธงเธญเธฑเธเธฉเธฃ)")
        self._register_password_entry = self._icon_entry(
            register, "๐”’", "เธเธฃเธญเธเธฃเธซเธฑเธชเธเนเธฒเธ", self._register_password, show="โ—", right_icon="๐‘"
        )
        ctk.CTkLabel(
            register,
            text="เนเธเนเธ•เธฑเธงเธญเธฑเธเธฉเธฃเธญเธขเนเธฒเธเธเนเธญเธข 8 เธ•เธฑเธงเธญเธฑเธเธฉเธฃ",
            text_color=PALETTE.text_muted,
            font=ctk.CTkFont(family=FONT_FAMILY, size=11),
        ).pack(anchor="w", padx=16, pady=(2, 0))
        self._field_label(register, "เธขเธทเธเธขเธฑเธเธฃเธซเธฑเธชเธเนเธฒเธ")
        self._register_password_confirm_entry = self._icon_entry(
            register, "๐”’", "เธเธฃเธญเธเธฃเธซเธฑเธชเธเนเธฒเธเธญเธตเธเธเธฃเธฑเนเธ", self._register_password_confirm, show="โ—", right_icon="๐‘"
        )
        ...
        self._register_button = self._primary_button(
            register, "เธชเธฃเนเธฒเธเธเธฑเธเธเธต โ”", self._register
        )
    ...
    def _build_program_view(self) -> None:
        ...
        ctk.CTkLabel(
            account_header,
            text="เธเธทเนเธเธ—เธตเนเนเธเนเธเธฒเธเธเธญเธเธเธธเธ“",
            font=ctk.CTkFont(family=FONT_FAMILY, size=15, weight="bold"),
            text_color=PALETTE.text,
        ).pack(side="left")
        ...
        ctk.CTkLabel(
            usage,
            text="เน€เธ•เธดเธกเธงเธฑเธเนเธเนเธเธฒเธ",
            font=ctk.CTkFont(family=FONT_FAMILY, size=14, weight="bold"),
            text_color=PALETTE.primary_dark,
        ...
        self._coupon_entry = ctk.CTkEntry(
            ...
            placeholder_text="NEKO-XXXXXXXX-โ€ฆ",
            height=34,
        )
        self._coupon_entry.pack(fill="x", padx=4, pady=(0, 6))
        self._redeem_button = self._primary_button(
            coupon_row, "เน€เธ•เธดเธกเธงเธฑเธเธเธฒเธเธเธนเธเธญเธ", self._redeem_coupon
        )
        ...
        ctk.CTkLabel(
            proxy,
            text="เธชเธ–เธฒเธเธฐเธเธฒเธฃเน€เธเธทเนเธญเธกเธ•เนเธญ (Connection Status)",
            font=ctk.CTkFont(family=FONT_FAMILY, size=14, weight="bold"),
            text_color=PALETTE.primary_dark,
        ).pack(anchor="w", padx=14, pady=(10, 4))
        ...
        ctk.CTkLabel(
            proxy,
            text="เธฃเธฐเธเธเธเธฐเน€เธเธดเธ” ProxyCore เธญเธฑเธ•เนเธเธกเธฑเธ•เธดเน€เธกเธทเนเธญเธเธ pso2.exe",
            text_color=PALETTE.text_muted,
            font=ctk.CTkFont(family=FONT_FAMILY, size=12),
            wraplength=340,
            justify="left",
        ...
        ctk.CTkLabel(
            game,
            text="เธ•เธฑเนเธเธเนเธฒเน€เธเนเธฒเน€เธเธก (PSO2 Tweaker)",
            font=ctk.CTkFont(family=FONT_FAMILY, size=14, weight="bold"),
            text_color=PALETTE.primary_dark,
        ).pack(anchor="w", padx=14, pady=(10, 4))
        ...
        self._game_path_entry = ctk.CTkEntry(
            ...
            placeholder_text="เธเธฃเธธเธ“เธฒเน€เธฅเธทเธญเธ Tweaker.exe เนเธเน€เธเธฃเธทเนเธญเธเธเธธเธ“",
            height=34,
        )
        self._game_path_entry.pack(side="left", fill="x", expand=True, padx=4)
        self._secondary_button(
            game_path_row,
            "เน€เธฅเธทเธญเธเนเธเธฅเน (Browse)",
            self._choose_game,
        ).pack(side="left", padx=4)

        self._auto_launch_checkbox = ctk.CTkCheckBox(
            game,
            text="เน€เธเธดเธ” Tweaker เธญเธฑเธ•เนเธเธกเธฑเธ•เธดเน€เธกเธทเนเธญเธฅเนเธญเธเธญเธดเธเธชเธณเน€เธฃเนเธ",
        ...
        self._launch_game_button = self._primary_button(
            game_controls,
            "เน€เธเธดเธ”เนเธเธฃเนเธเธฃเธก PSO2 Tweaker",
            self._launch_game,
        )
    ...
    def _open_password_dialog(self) -> None:
        ...
        dialog_width = 400
        dialog_height = 380
        dialog.title("เน€เธเธฅเธตเนเธขเธเธฃเธซเธฑเธชเธเนเธฒเธ")
        ...
        ctk.CTkLabel(
            dialog_controls,
            text="เน€เธเธฅเธตเนเธขเธเธฃเธซเธฑเธชเธเนเธฒเธ",
            font=ctk.CTkFont(family=FONT_FAMILY, size=18, weight="bold"),
            text_color=PALETTE.primary_dark,
        ...
        ctk.CTkLabel(
            panel,
            text="เธ•เธฑเนเธเธฃเธซเธฑเธชเธเนเธฒเธเนเธซเธกเนเธญเธขเนเธฒเธเธเนเธญเธข 8 เธ•เธฑเธงเธญเธฑเธเธฉเธฃ",
            font=ctk.CTkFont(family=FONT_FAMILY, size=12),
            text_color=PALETTE.text_muted,
        ).pack(anchor="w", padx=18, pady=(0, 8))

        self._field_label(panel, "เธฃเธซเธฑเธชเธเนเธฒเธเนเธซเธกเน")
        ...
        self._field_label(panel, "เธขเธทเธเธขเธฑเธเธฃเธซเธฑเธชเธเนเธฒเธเนเธซเธกเน")
        self._new_password_confirm_entry = self._entry(
            panel,
            "เธขเธทเธเธขเธฑเธเธฃเธซเธฑเธชเธเนเธฒเธเนเธซเธกเน",
    ...
    def _restore_completed(self, restored: bool) -> None:
        if restored:
            self._notice.set("เธเธนเนเธเธทเธเธเธฒเธฃเน€เธเนเธฒเธชเธนเนเธฃเธฐเธเธเธชเธณเน€เธฃเนเธ")
            self._auto_launch_tweaker()
        elif self._controller.state.auth_status is AuthStatus.SIGNED_OUT:
            self._status.set("เธขเธฑเธเนเธกเนเนเธ”เนเน€เธเนเธฒเธชเธนเนเธฃเธฐเธเธ")

    def _login_succeeded(self, _: Any) -> None:
        self._login_password.set("")
        self._notice.set("เน€เธเนเธฒเธชเธนเนเธฃเธฐเธเธเธชเธณเน€เธฃเนเธ")
        self._auto_launch_tweaker()

    def _register(self) -> None:
        password = self._register_password.get()
        if not password or password != self._register_password_confirm.get():
            self._error.set("เธฃเธซเธฑเธชเธเนเธฒเธเนเธฅเธฐเธเธฒเธฃเธขเธทเธเธขเธฑเธเนเธกเนเธ•เธฃเธเธเธฑเธ")
            return
        self._submit(
    ...
    def _register_succeeded(self, result: RegistrationResult) -> None:
        ...
        if result.requires_email_confirmation:
            self._notice.set(
                "เธฃเธฑเธเธเธณเธเธญเธชเธกเธฑเธเธฃเธชเธกเธฒเธเธดเธเนเธฅเนเธง เธซเธฒเธเธฃเธฐเธเธเธชเนเธเธญเธตเน€เธกเธฅเธขเธทเธเธขเธฑเธ "
                "เธเธฃเธธเธ“เธฒเธ•เธฃเธงเธเธเธฅเนเธญเธเธเธ”เธซเธกเธฒเธขเธเนเธญเธเน€เธเนเธฒเธชเธนเนเธฃเธฐเธเธ"
            )
        else:
            self._notice.set(
                "เธชเธกเธฑเธเธฃเธชเธกเธฒเธเธดเธเธชเธณเน€เธฃเนเธ เนเธเนเธเธทเนเธญเธเธนเนเนเธเนเนเธฅเธฐเธฃเธซเธฑเธชเธเนเธฒเธเน€เธเนเธฒเธชเธนเนเธฃเธฐเธเธเนเธ”เนเน€เธฅเธข"
            )

    def _change_password(self) -> None:
        password = self._new_password.get()
        if not password or password != self._new_password_confirm.get():
            self._error.set("เธฃเธซเธฑเธชเธเนเธฒเธเนเธซเธกเนเนเธฅเธฐเธเธฒเธฃเธขเธทเธเธขเธฑเธเนเธกเนเธ•เธฃเธเธเธฑเธ")
            return
        self._submit(
    ...
    def _password_changed(self, _: Any) -> None:
        self._close_password_dialog()
        self._notice.set("เน€เธเธฅเธตเนเธขเธเธฃเธซเธฑเธชเธเนเธฒเธเธชเธณเน€เธฃเนเธ")
    ...
    def _signed_out(self, _: Any) -> None:
        ...
        self._notice.set("เธญเธญเธเธเธฒเธเธฃเธฐเธเธเนเธฅเนเธง")
    ...
    def _choose_game(self) -> None:
        selected = filedialog.askopenfilename(
            title="เน€เธฅเธทเธญเธเนเธเธฅเนเน€เธเธดเธ”เน€เธเธก",
            filetypes=[
                ("เนเธเธฅเนเน€เธเธดเธ”เน€เธเธก", "Tweaker.exe"),
                ("เนเธเธฃเนเธเธฃเธก Windows", "*.exe"),
                ("เนเธเธฅเนเธ—เธฑเนเธเธซเธกเธ”", "*.*"),
            ],
        )
        if not selected:
            return
        ...
        if self._game_path_store:
            try:
                ...
                pass
        self._notice.set("เธเธฑเธเธ—เธถเธเนเธเธฅเนเน€เธเธดเธ”เน€เธเธกเนเธฅเนเธง")
    ...
    def _launch_tweaker_only(self) -> None:
        ...
        if self._controller.state.game_status is GameStatus.RUNNING:
            self._notice.set("เน€เธเธดเธ”เนเธเธฃเนเธเธฃเธก PSO2 Tweaker เนเธฅเนเธง")

    def _selected_tweaker_executable(self) -> str | None:
        raw_path = self._game_path.get().strip().strip('"')
        if not raw_path:
            self._error.set("เธเธฃเธธเธ“เธฒเน€เธฅเธทเธญเธเนเธเธฅเน Tweaker.exe เธเนเธญเธ")
            return None

        executable = Path(os.path.expandvars(raw_path)).expanduser()
        if not executable.is_file():
            self._error.set(
                "เนเธกเนเธเธเนเธเธฅเน Tweaker.exe เธเธฃเธธเธ“เธฒเธเธ” Browse เนเธฅเนเธงเน€เธฅเธทเธญเธเนเธเธฅเนเนเธซเธกเน"
            )
            return None
    ...
    def _coupon_redeemed(self, result: Any) -> None:
        self._coupon_code.set("")
        self._notice.set(
            f"เน€เธ•เธดเธกเธงเธฑเธเธชเธณเน€เธฃเนเธ +{result.days_added} เธงเธฑเธ "
            f"เธซเธกเธ”เธญเธฒเธขเธธ {result.valid_until:%d/%m/%Y %H:%M}"
        )
    ...
    def _drain_events(self) -> None:
        ...
        for future, on_success in self._pending:
            ...
            try:
                ...
                self._error.set("เน€เธเธดเธ”เธเนเธญเธเธดเธ”เธเธฅเธฒเธ” เธเธฃเธธเธ“เธฒเธฅเธญเธเนเธซเธกเน")
            else:
                if on_success:
                    on_success(result)
    ...
    def _render_state(self, state: AppState) -> None:
        ...
        self._status.set(
            {
                AuthStatus.SIGNED_OUT: "เธขเธฑเธเนเธกเนเนเธ”เนเน€เธเนเธฒเธชเธนเนเธฃเธฐเธเธ",
                AuthStatus.AUTHENTICATING: "เธเธณเธฅเธฑเธเน€เธเนเธฒเธชเธนเนเธฃเธฐเธเธโ€ฆ",
                AuthStatus.AUTHENTICATED: "เน€เธเนเธฒเธชเธนเนเธฃเธฐเธเธเนเธฅเนเธง",
                AuthStatus.FAILED: "เน€เธเนเธฒเธชเธนเนเธฃเธฐเธเธเนเธกเนเธชเธณเน€เธฃเนเธ",
            }[state.auth_status]
        )
        ...
        self._game_connection_status.set(
            "เธชเธ–เธฒเธเธฐเน€เธเธก: เน€เธเนเธฒเน€เธเธกเนเธฅเนเธง (เธเธ pso2.exe)"
            if state.game_process_running
            else "เธชเธ–เธฒเธเธฐเน€เธเธก: เธขเธฑเธเนเธกเนเน€เธเนเธฒเน€เธเธก (เธฃเธญ pso2.exe)"
        )
        proxy_text = {
            ProxyStatus.STOPPED: "ProxyCore: เธขเธฑเธเนเธกเนเธ—เธณเธเธฒเธ",
            ProxyStatus.STARTING: "ProxyCore: เธเธณเธฅเธฑเธเน€เธฃเธดเนเธกเธ—เธณเธเธฒเธ...",
            ProxyStatus.RUNNING: "ProxyCore: เธ—เธณเธเธฒเธเนเธฅเนเธง",
            ProxyStatus.STOPPING: "ProxyCore: เธเธณเธฅเธฑเธเธซเธขเธธเธ”เธ—เธณเธเธฒเธ...",
            ProxyStatus.FAILED: "ProxyCore: เน€เธฃเธดเนเธกเธ—เธณเธเธฒเธเนเธกเนเธชเธณเน€เธฃเนเธ",
        }[state.proxy_status]
    ...
    def _render_entitlement(self, state: AppState) -> None:
        ...
        if entitlement is None:
            self._entitlement.set(
                "เน€เธซเธฅเธทเธญ 0 เธงเธฑเธ โ€ข เน€เธ•เธดเธกเธงเธฑเธเธ”เนเธงเธขเธเธนเธเธญเธเน€เธเธทเนเธญเน€เธฃเธดเนเธกเธ•เนเธ"
            )
            self._entitlement_label.configure(text_color=PALETTE.warning)
            return
        if entitlement.valid_until is None:
            self._entitlement.set("เนเธเนเธเธฒเธเนเธ”เน โ€ข เนเธกเนเธเธณเธเธฑเธ”เธงเธฑเธ")
        ...
        if entitlement.status is EntitlementStatus.ACTIVE and remaining.total_seconds() > 0:
            ...
            self._entitlement.set(
                f"เนเธเนเธเธฒเธเนเธ”เน โ€ข เน€เธซเธฅเธทเธญเธเธฃเธฐเธกเธฒเธ“ {days} เธงเธฑเธ โ€ข "
                f"เธซเธกเธ”เธญเธฒเธขเธธ {entitlement.valid_until:%d/%m/%Y %H:%M}"
            )
            self._entitlement_label.configure(text_color=PALETTE.success)
        else:
            if state.game_process_running:
                self._entitlement.set(
                    "เธชเธดเธ—เธเธดเนเธซเธกเธ”เธญเธฒเธขเธธเนเธฅเนเธง โ€ข เธเธฐเธ•เธฑเธ”เธเธฒเธฃเน€เธเธทเนเธญเธกเธ•เนเธญเธซเธฅเธฑเธเธญเธญเธเธเธฒเธเน€เธเธก"
                )
                self._entitlement_label.configure(text_color=PALETTE.warning)
            else:
                self._entitlement.set(
                    f"เธซเธกเธ”เธญเธฒเธขเธธเนเธฅเนเธง โ€ข เน€เธซเธฅเธทเธญ 0 เธงเธฑเธ โ€ข "
