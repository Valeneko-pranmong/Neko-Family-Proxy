...
STABLE_RELEASE_EXPECTED_TAG = "v5.1.2"
STABLE_RELEASE_EXPECTED_CHANNEL = "stable"
STABLE_RELEASE_EXPECTED_SEQUENCE = 6
STABLE_RELEASE_EXPECTED_MIN_SEQUENCE = 1
STABLE_RELEASE_EXPECTED_RELEASE_ID = "stable-0006"
STABLE_RELEASE_EXPECTED_COMPONENT_VERSION = "5.1.2"
