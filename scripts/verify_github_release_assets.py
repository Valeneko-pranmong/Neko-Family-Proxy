...
STABLE_RELEASE_EXPECTED_TAG = "v5.1.3"
STABLE_RELEASE_EXPECTED_CHANNEL = "stable"
STABLE_RELEASE_EXPECTED_SEQUENCE = 7
STABLE_RELEASE_EXPECTED_MIN_SEQUENCE = 1
STABLE_RELEASE_EXPECTED_RELEASE_ID = "stable-0007"
STABLE_RELEASE_EXPECTED_COMPONENT_VERSION = "5.1.3"
